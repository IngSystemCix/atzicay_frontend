...
export class DashboardComponent {
  ...
  games: GameType[] = [
    {
      id: 1,
      title: 'Puzzle: Matemáticas Divertidas',
      level: 'Básico',
      description: 'Aprende operaciones básicas de forma divertida',
      rating: 4.8,
      author: 'Pedrito Patroclo',
      image: 'assets/rompecabezas.png',
    },
    {
      id: 2,
      title: 'Pupiletras: Aventura Gramatical',
      level: 'Intermedio',
      description: 'Mejora tu gramática con esta aventura interactiva',
      rating: 4.8,
      author: 'Pedrito Patroclo',
      image: 'assets/pupiletras.png',
    },
    {
      id: 3,
      title: 'Memoria: Química Básica',
      level: 'Básico',
    ...
    {
      id: 4,
      title: 'Ahorcado: Historia Mundial',
      level: 'Avanzado',
    ...
    {
      id: 5,
      title: 'Memoria: Física Elemental',
      level: 'Intermedio',
    ...
    {
      id: 6,
      title: 'Pupiletras: Biología Celular',
      level: 'Avanzado',
    ...
    {
      id: 7,
      title: 'Memoria: Geometría Espacial',
      level: 'Básico',
    ...
    {
      id: 8,
      title: 'Ahorcado: Aritmética Matemática',
      level: 'Intermedio',
